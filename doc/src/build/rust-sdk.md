...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let my_address = SuiAddress::from_str("sui1zupu00ayxqddcu3vrthm2ppe9409r504fqn7cjwl9lpmsjufqjhss6yl72")?;
    let gas_object_id = ObjectID::from_str("sui1r8e5df4tf99jwuf6s0n8mkdauspfcq3yd3xd5twej7e2qlshwamqyt60u9")?;
